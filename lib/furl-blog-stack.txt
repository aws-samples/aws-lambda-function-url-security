...
const userPoolLoginUrlSsmParam = new ssm.StringParameter(this, 'userPoolLoginUrl', {parameterName: '/lambdaFurl/cognitoUrl', stringValue: signInUrl, removalPolicy: cdk.RemovalPolicy.DESTROY});
userPoolLoginUrlSsmParam.node.addDependency(userPoolClient);
